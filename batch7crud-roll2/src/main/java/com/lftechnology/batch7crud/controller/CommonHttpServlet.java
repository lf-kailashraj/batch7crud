...
public abstract class CommonHttpServlet extends HttpServlet {
    ...
    public void displayPageNotFound(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    ...
    public void displayErrorPage(HttpServletRequest req, HttpServletResponse res, String message) throws ServletException, IOException {
